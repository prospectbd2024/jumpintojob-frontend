    ...
    return (
        <DashboardLayout>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
                <div
                    ...
                    <div className="flex space-x-2">
                        <button
                            className="flex items-center space-x-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition duration-300 ease-in-out">
                            <Filter size={20}/>
                            <span>Filter</span>
                        </button>
                        <button
                ...
                {!loadingApplyJob &&  filteredJobs.map((job) => (
                    <div key={job.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                        ...
                        <div className="bg-gray-50 dark:bg-gray-700 p-4 flex justify-between">
                            <button className="text-blue-600 hover:text-blue-800 dark:hover:text-blue-400">View
                                Details
                            </button>
                            <button className="text-red-600 hover:text-red-800 dark:hover:text-red-400">Withdraw
                                Application
                            </button>
                        </div>
                    </div>
            ...
            <div className="flex justify-center mt-6">
                {Array.from({length: appliedJobTotalPages}, (_, index) => (
                    <button
                        key={index + 1}
                        onClick={() => appliedJobPaginate(index + 1)}
                        className={`px-4 py-2 mx-1 border rounded-md ${appliedJobCurrentPage === index + 1 ? 'bg-blue-500 text-white' : 'bg-white text-gray-700'}`}
                    >
                        {index + 1}
                    </button>
                ))}
