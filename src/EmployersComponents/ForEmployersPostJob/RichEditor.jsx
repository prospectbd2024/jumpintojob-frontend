    ...
    return (
        <div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '50px' }}>
                <label style={{ fontSize: '17px', color: '#061421' }} htmlFor="richtext">Job Details</label>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '50px' }}>
                <label style={{ fontSize: '17px', color: '#061421' }} htmlFor="richtext">Responsibilities</label>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '50px' }}>
                <label style={{ fontSize: '17px', color: '#061421' }} htmlFor="richtext">Educational Requirements</label>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '50px' }}>
                <label style={{ fontSize: '17px', color: '#061421' }} htmlFor="richtext">Required Experience</label>
