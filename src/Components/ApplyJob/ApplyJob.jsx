...
const ApplyJob = ({ job }) => {
    ...
    const { apply, message, forwardingLetter, setForwardingLetter, resume, setResume, CV, setCV, getResume } =
    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            {message.message && (
                <div
                    className={`mb-6 p-4 rounded-md flex items-center space-x-2 ${message.type === "success"
                        ...
                        <div className="flex justify-end">
                            {isLoading ? (
                                ...
                                <button
                                    ...
                                    className={`px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-300 ${(!CV && !resume) || !job ? "opacity-50 cursor-not-allowed" : ""
                                        }`}
                                    type="button"
                                >
                                    Apply Now
