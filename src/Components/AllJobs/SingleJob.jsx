...
const SingleJob = ({ job, clickedJob, handleClickedJob }) => {
  return (
    <div
      className={`relative rounded-lg p-4 shadow-sm border-b-4 border-transparent transition duration-300 ease-in-out ${
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <HiOutlineBookmark
          className="text-gray-900 cursor-pointer w-4 h-4 bg-green-300 p-1 rounded-full transition duration-300 ease-in-out hover:text-white hover:bg-green-600"
        />
      </div>
